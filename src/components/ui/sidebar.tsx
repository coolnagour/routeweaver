  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
            "sticky top-0 hidden h-screen md:flex flex-col text-sidebar-foreground transition-[width] duration-200 ease-linear border-r",
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex flex-1 flex-col px-4 sm:px-6 lg:px-8",
        className
      )}
      {...props}
    />
